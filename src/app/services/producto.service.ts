...
export class ProductoService{
   ...
   /* addProducto(producto: Producto){
    ...
    addProducto(producto: Producto){
        var Operation:string = this.localurl + "CrearProducto";
        ...
        return this._http.put(Operation, JSON.stringify(POSTProducto), options).pipe(map(res => res.json()));
    }
